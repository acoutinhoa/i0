...
urlpatterns = [
    ...
    url(r'^f7/(?P<tp>img)/(?P<a>[01x])/(?P<b>[0])/\[(?P<c>.+\.(gif|jpg|jpeg))\]/(?P<d>[vhx]\d*)/(?P<e>[01x])/$', f7, name='f7'),
    url(r'^bg/(?P<tp>img)/(?P<a>[01x])/(?P<b>[0])/\[(?P<c>.+\.(gif|jpg|jpeg))\]/(?P<d>[vhx]\d*)/(?P<e>[01x])/$', bg, name='bg'),
