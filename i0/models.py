...
class TP(models.Model):
	...
	pae = models.ForeignKey(User)
	tptp = models.ForeignKey('self', limit_choices_to={'tptp__isnull':True}, blank=True, null=True)
...
class I0(models.Model):
	...
	d0 = models.DateTimeField(auto_now_add = True)
	pae = models.ForeignKey(User)
	tp = models.ForeignKey(TP, limit_choices_to={'tptp__isnull':True})
...
class TXT(models.Model):
	...
	tp = models.ForeignKey(TP, limit_choices_to={'tptp_id':2})
