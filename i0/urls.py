...
urlpatterns = [
    ...
    url(r'^f7/(?P<tp>rgb)/(?P<a>[01x])/(?P<b>[0])/(?P<c>([01x]{3}|pb|rgb|piet|cmyx))/(?P<d>x)/(?P<e>[01x])/$', f7, name='f7'),
    url(r'^bg/(?P<tp>rgb)/(?P<a>[01x])/(?P<b>[0])/(?P<c>([01x]{3}|pb|rgb|piet|cmyx))/(?P<d>x)/(?P<e>[01x])/$', bg, name='bg'),
    ...
    url(r'^f7/(?P<tp>piet)/(?P<a>[01x])/(?P<b>[01x])/(?P<c>([01x]{3}|pb|rgb|piet|cmyx))/(?P<d>x)/(?P<e>[01x])/$', f7, name='f7'),
    url(r'^bg/(?P<tp>piet)/(?P<a>[01x])/(?P<b>[01x])/(?P<c>([01x]{3}|pb|rgb|piet|cmyx))/(?P<d>x)/(?P<e>[01x])/$', bg, name='bg'),
]
